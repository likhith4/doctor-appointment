...
const resetPassword = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const uniqueStringHashed = bcrypt_1.default.hashSync(uniqueString, 12);
...
const PassworResetConfirm = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (expiresAt.isBefore(currentTime)) {
            throw new apiError_1.default(http_status_1.default.NOT_FOUND, "Forgot request has expired!");
        }
        yield tx.auth.update({
            where: { id: userId },
            data: {
                password: password ? bcrypt_1.default.hashSync(password, 12) : undefined
            }
        });
        yield tx.forgotPassword.delete({
