...
const createAppointment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            yield (0, emailTransporter_1.EmailtTransporter)({ pathName, replacementObj, toMail, subject });
        }
        catch (error) {
...
const createAppointmentByUnAuthenticateUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        patientInfo['trackingId'] = trackingId;
        const doctorIdForUnauth = patientInfo.doctorId || config_1.default.defaultAdminDoctor;
        patientInfo['doctorId'] = doctorIdForUnauth;
        const doctorForFee = yield tx.doctor.findUnique({ where: { id: doctorIdForUnauth } });
        if (!doctorForFee) {
            throw new apiError_1.default(http_status_1.default.NOT_FOUND, 'Doctor Account is not found !!');
        }
